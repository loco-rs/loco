...
- Feat: Mailer templates now support full Tera template features including inheritance, blocks, and extends. Templates can also be shared across multiple mailers using `Template::new_with_shared()`. [https://github.com/loco-rs/loco/pull/1694](https://github.com/loco-rs/loco/pull/1694)
