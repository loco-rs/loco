...
// Ukrainian slide copy — mirrors SLIDES (same `k` keys, same order). home.ts
// picks the right set from the document's language; the CODE panel is shared
// since code is language-neutral.
export const SLIDES_UK: Slide[] = [
  {k:'controller', title:'Опрацюйте запит.', bullets:[
    '<b>Без макросів, без магії.</b> Звичайна <code>async fn</code>, що повертає <code>Result&lt;Response&gt;</code>.',
    '<b>Зʼєднано через Routes.</b> Контекст застосунку — db, config, воркери — передається вам.',
    '<b>Типізовано в обидва боки.</b> Екстрактори на вході, серіалізовані відповіді на виході.']},
  {k:'model', title:'Ваші дані та їхня логіка.', bullets:[
    '<b>Сутності плюс ваші методи.</b> Запити й правила живуть поруч із даними.',
    '<b>Без шаблонного коду.</b> Ніяких рядкових SQL, ніякого шару репозиторіїв.',
    '<b>Типізовано від початку до кінця.</b> Компілятор перевіряє колонки та звʼязки.']},
  {k:'worker', title:'Виносіть повільну роботу зі шляху запиту.', bullets:[
    '<b>Типізовані аргументи.</b> Завдання виконуються поза смугою запиту.',
    '<b>Ставте в чергу через <code>perform_later</code>.</b> Викликав — і забув.',
    '<b>Будь-яка черга.</b> Postgres, SQLite чи Redis — той самий код, без переписування.']},
  {k:'view', title:'Формуйте те, що покидає API.', bullets:[
    '<b>Вирішуйте формат передачі.</b> Серіалізатори обирають, що саме відправити.',
    '<b>Незалежно від схеми.</b> Форма API — не форма таблиці.',
    '<b>Еволюціонує незалежно.</b> Змінюйте одне, не ламаючи іншого.']},
  {k:'task', title:'Запускайте операції з CLI або за розкладом.', bullets:[
    '<b>Типізовані команди.</b> Запуск через <code>cargo loco task</code> — бекфіли, сіди, обслуговування.',
    '<b>За розкладом.</b> Вбудований планувальник запускає їх за cron.',
    '<b>Частина застосунку.</b> Зареєстровані й типізовані — без випадкових скриптів.']},
  {k:'mailer', title:'Транзакційна пошта за шаблонами.', bullets:[
    '<b>За шаблонами.</b> Тема, текст і HTML рендеряться з шаблонів.',
    '<b>Надсилає через SMTP.</b> Дев-мейлер перехоплює листи локально.',
    '<b>У коробці.</b> Не треба підключати сторонній поштовий сервіс.']}
];
