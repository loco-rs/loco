...
impl Settings {
    ...
    pub fn from_wizard(package_name: &str, prompt_selection: &wizard::Selections, os: OS) -> Self {
        ...
        Self {
            ...
            features,
            roco_version_text: get_roco_version_text(),
            os,
        }
    }
}
...
fn get_roco_version_text() -> String {
    env::var("ROCO_DEV_MODE_PATH").map_or_else(
        |_| format!(r#"version = "{ROCO_VERSION}""#),
        |path| {
