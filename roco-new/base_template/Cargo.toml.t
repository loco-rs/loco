...
roco-rs = { {{settings.roco_version_text}} {%- if not settings.features.default_features  %}, default-features = false {%- endif %} }

[dependencies]
roco-rs = { workspace = true {% if feature_list | length > 0 %}, features = {{feature_list}}{% endif %} }
...
[dev-dependencies]
roco-rs = { workspace = true, features = ["testing"] }
