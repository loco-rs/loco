...
use roco_gen::{collect_messages, generate, tera_ext, AppInfo, Component, ScaffoldKind};
use rrgen::RRgen;
use rstest::rstest;
use std::fs;
...
// thread 'templates::scaffold::can_generate::case_1' panicked at roco-gen/tests/templates/scaffold.rs:48:6:
