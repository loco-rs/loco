...
/// For example, the `created_at` and `updated_at` fields are automatically generated by the Loco app and should be given
pub const SKIP_FIELDS: &[&str] = &["created_at", "updated_at", "create_at", "update_at"];
...
pub fn generate<H: Hooks>(
    ...
    for (fname, ftype) in fields {
        if SKIP_FIELDS.contains(&fname.as_str()) {
            continue;
        }
        if ftype == "references" {
